        ...
        <div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <p>Reported bugs: {reportValuesModal.join(', ')}</p>
                            <p>Optional Features: {featureValuesModal.join(', ')}</p>
                            <p>Software: {dropdownValueModal}</p>
                        </div>
            ...
            <div className='container border border-dark'>
                <div className="container text-center" id="dd">
                    {isReportSent && <h5 className='my-3'>Report sent successfully!</h5>}
